...
### Features
- **Project Save/Load** — Save and restore your editing sessions as `.crosscap` project files. Use `Ctrl+S` / `Cmd+S` to save, `Ctrl+O` / `Cmd+O` to open.
...
| Platform | File |
|----------|------|
| Windows | `CrossCap-Setup-1.1.3.exe` |
| macOS (Intel) | `CrossCap-Mac-x64-1.1.3-Installer.dmg` |
| macOS (Apple Silicon) | `CrossCap-Mac-arm64-1.1.3-Installer.dmg` |
| Linux | `CrossCap-Linux-1.1.3.AppImage` |
...
**macOS** — Open the `.dmg` and drag CrossCap to Applications. On first launch, right-click the app and select "Open" to bypass Gatekeeper. If you encounter permission issues, grant Full Disk Access in System Settings > Privacy & Security.

**Linux** — Make the AppImage executable and run it:
```bash
chmod +x CrossCap-Linux-1.1.3.AppImage
./CrossCap-Linux-1.1.3.AppImage
```
